...
Public Class frmMantSubj
    ...
    Const FORM_DESCRIP As String = "Manteniment Subjectivitat"
    Const CONNEX_DESCRIP As String = "Classificació Subjectiva"
...
#Region " Funcions internes"
    ...
    Private Sub SaveRecord()
        ...
        For i As Short = 0 To 2
            ...
            Select Case i
                Case 0 : If IsLoadForm("frmTemes") Then combo = frmTemes.ComboSubj
                Case 1 : If IsLoadForm("frmjingels") Then combo = frmJingels.ComboSubj
                Case 2 : If IsLoadForm("frmPromos") Then combo = frmPromos.ComboSubj
            End Select
...
#End Region
    ...
    Private Sub TabControlMesInfo_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles TabControlMesInfo.MouseUp
        If TabControlMesInfo.SelectedIndex = 1 Then
            Dim db As New MSC.db.clsDBS
            Dim StrSql As String = "SELECT temID, temTitol FROM `temes` where temSubjID =" & Me.lbID.Text
