...
Public Class frmMantComercial
	Dim blEnable As Boolean
	Dim blnNouRecord As Boolean
	Dim IsSaving As Boolean = False
	
	Const TAULA_ID As TAULES_DBS = TAULES_DBS.TAULA_AGENTS_COMERCIALS
	
	'Const CONNEX_DESCRIP As String = "Agents Comercials"
	...
	Public Sub setLanguageForm()
		...
		FORM_DESCRIP  = lang.getText("FORM_DESCRIP")'"Manteniment d'Agents Comercials"
		Me.TabPage1.Text = lang.getText("TabPage1.Text")'"LListat Comercials"
		Me.TabPage2.Text = lang.getText("TabPage2.Text")'"Clients del comercial"
	...
	Private Sub CloseForm()
        ...
        MyAPP.CloseSesionClient(MyAPP.IDSesion_Client, DESCRIP_FORM_COMERCIAL)
    End Sub
	...
	Private Sub TabControlMesInfo_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles TabControlMesInfo.MouseUp
		If TabControlMesInfo.SelectedIndex = 1 Then
            Dim db As New MSC.dbs(Cloud)
            Dim StrSql As String = "SELECT cli_id, cli_nom FROM `clients` where cli_agent =" & Me.lbID.Text
