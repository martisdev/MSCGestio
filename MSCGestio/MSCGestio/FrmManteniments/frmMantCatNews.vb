...
Public Class frmMantCatNews
	Dim blEnable As Boolean
	Dim blnNouRecord As Boolean
	Dim IsSaving As Boolean = False
	
	Const TAULA_ID As TAULES_DBS = TAULES_DBS.TAULA_CATEGORIA_NEWS
    ...
    Public Sub setLanguageForm()
		...
		Me.ToolStripMenuItem2.Text = lang.getText("LABEL_PROGRAMA",True) '"Programa"
		Me.ToolStripMenuItem3.Text = lang.getText("LABEL_EXIT",True) '"Sortir"
		Me.ToolStripMenuItem4.Text = lang.getText("mnuEdit.Text",True )'"Edició"
		Me.ToolStripMenuItem5.Text = lang.getText("LABEL_MODIFICAR",True )'"Modificar"
		Me.ToolStripMenuItem6.Text = lang.getText("LABEL_SALVAR",True) '"Salvar"
		Me.ToolStripMenuItem7.Text = lang.getText("LABEL_NEW",True) '"Nou"
		Me.ToolStripMenuItem8.Text = lang.getText("LABEL_DELETE",True) '"Borrar"
		Me.ToolStripMenuItem9.Text = lang.getText("LABEL_REFRESCAR",True)'"Refrescar"
		Me.ToolStripMenuItem10.Text = lang.getText("mnu_Help",True) '"Ajuda"
		Me.ToolStripMenuItem11.Text = lang.getText("mnuRefHelp.Text",True) '"Manual OnLine"
		...
		Me.Text = lang.getText("Text")'"Categories de Notícies"
	...
	Private Sub DeleteRecord()
        ...
        For i As Short = 0 To Me.gridDades.SelectedRows.Count - 1
            ...
            db.Delete_ID(StrSql)
        Next
        addCtlRadi(0, CShort(Tipus_Play.CTL_SQL), 0, "00:00:00", 0, 0, Usuari.UsrID, "DELETE FROM " & TAULA_NOM, 0, False)
	...
	Private Sub CloseForm()
        ...
        MyAPP.CloseSesionClient(MyAPP.IDSesion_Client, DESCRIP_FORM_CAT_NEWS)
    End Sub
