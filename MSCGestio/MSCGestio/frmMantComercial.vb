...
Public Class frmMantComercial
    ...
    Const FORM_DESCRIP As String = "Manteniment d'Agents Comercials"
...
#Region " Funcions internes"
    ...
    Private Sub SaveRecord()        
        ...
        If blnNouRecord = True Then
            ...
            Dim NewID = db.New_ID(StrSql)
            Me.gridDades.Rows(gridDades.NewRowIndex).Cells(0).Value = NewID
            gridDades.EndEdit()
...
#End Region
    ...
    Private Sub TabControlMesInfo_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles TabControlMesInfo.MouseUp
        If TabControlMesInfo.SelectedIndex = 1 Then
            Dim db As New MSC.db.clsDBS
            Dim StrSql As String = "SELECT cliID, cliNom FROM `clients` where cliAgent =" & Me.lbID.Text
