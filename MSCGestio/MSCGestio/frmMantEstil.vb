...
Public Class frmMantEstil
    ...
    Const FORM_DESCRIP As String = "Manteniment Estils"
    Const CONNEX_DESCRIP As String = "Estils"
...
#Region " Funcions internes"
    ...
    Private Sub SaveRecord()
        ...
        For i As Short = 0 To 4
            ...
            Select Case i
                Case 0 : If IsLoadForm("frmDiscos") Then combo = frmDiscos.ComboEstil
                Case 1 : If IsLoadForm("frmTemes") Then combo = frmTemes.ComboEstil
                Case 2 : If IsLoadForm("frmImport") Then combo = frmImport.cbEstil
                Case 3 : If IsLoadForm("frmjingels") Then combo = frmJingels.ComboEstil
                Case 4 : If IsLoadForm("frmPromos") Then combo = frmPromos.ComboEstil
            End Select
...
#End Region
    ...
    Private Sub TabControlMesInfo_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles TabControlMesInfo.MouseUp
        If TabControlMesInfo.SelectedIndex = 1 Then
            Dim db As New MSC.db.clsDBS
            Dim StrSql As String = "SELECT discID, discNom FROM `discos` where discEstilID =" & Me.lbID.Text
        ...
        ElseIf TabControlMesInfo.SelectedIndex = 2 Then
            Dim db As New MSC.db.clsDBS
            Dim StrSql As String = "SELECT temID, temTitol FROM `temes` where temEstilID =" & Me.lbID.Text
            Dim dt As DataTable = db.getTable(StrSql)            
